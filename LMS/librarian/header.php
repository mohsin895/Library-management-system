...
<head>
    ...
    <!--Magnific popup-->
    <link rel="stylesheet" href="../assets/vendor/magnific-popup/agnific-popup.css">
        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <span class="user-name"><?=ucwords($libraian_info['fname'].' '.$libraian_info['lname']) ?></span>
                        ...
                        <ul class="nav nav-left-lines" id="main-nav">
                            ...
                            <li class="has-child-item close-item <?= $page == 'add-book.php' ? 'open-item':''?> <?= $page ==  'manage-books.php' ? 'open-item':''?>">
                                ...
                                <ul class="nav child-nav level-1">
                                    ...
                                    <li class="<?= $page == 'manage-books.php' ? 'active-item':''?>"><a href="manage-books.php">Manage Book</a></li>


                                </ul>
                            </li>
                            <li class="<?= $page == 'issue-books.php' ? 'active-item':''?>"><a href="issue-books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Issue Book</span></a></li>
